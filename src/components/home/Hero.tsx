...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden bg-navy">
      ...
      {/* Background grid (Linear-style, 3%) */}
      <BackgroundGrid opacity={0.03} size={40} />

      {/* Particles network */}
      <Particles count={30} />

      {/* Spotlight following mouse */}
      <Spotlight size={500} color="rgba(255, 255, 255, 0.08)" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-2 pb-16">
        <div className="grid lg:grid-cols-[1fr_440px] gap-12 lg:gap-8 items-center">
          ...
          <div className="text-left pt-24">
            ...
            <div className="animate-fade-up animation-delay-100 inline-flex items-center gap-2
              ...
              style={{
                ...
                boxShadow: '0 0 50px rgba(234,87,13,0.1)',
              }}
            >
            ...
            <h1 className="font-poppins font-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl
              leading-[1.05] text-white mb-2">
              <span className="block overflow-hidden">
                <SplitText text={t.hero.headline1} delay={300} stagger={0.05} />
              </span>
              <span className="block overflow-hidden">
            ...
            <p className="animate-fade-up animation-delay-1300
              font-inter text-base md:text-lg text-gray-300 max-w-xl leading-relaxed mb-8">
              {t.hero.description}
            </p>
            ...
            <div className="animate-fade-up animation-delay-1500
              ...
              <Magnetic strength={0.25}>
                <Link
                  to="/contact"
                  className="group flex items-center gap-2 text-white font-poppins font-semibold
                    px-7 py-3.5 rounded-full transition-all duration-300 hover:-translate-y-0.5 text-sm
                    relative overflow-hidden"
                  style={{
                    background: 'linear-gradient(90deg, #EA570D, #FF7A28)',
                    boxShadow: '0 4px 24px rgba(234,87,13,0.3)',
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = '0 0 40px rgba(234,87,13,0.6), 0 4px 24px rgba(234,87,13,0.4)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow = '0 4px 24px rgba(234,87,13,0.3)';
                  }}
                >
          ...
          <div className="animate-fade-in animation-delay-600 hidden lg:block relative h-[500px]">
            <HeroIllustration />
          </div>
        </div>
      </div>
